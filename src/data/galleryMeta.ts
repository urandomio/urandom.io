...
export const galleryMeta: GalleryMetaEntry[] = [
  ...
  {
    src: '/gallery/bender-flux-moth-library-20260924-1033.png',
    title: 'Moth Library',
    description: 'A luminous moth hangs over a deserted reading room, its wings stretching between rows of books.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'moth', 'library', 'surreal'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-rain-archive-20260924-1034.png',
    title: 'Rain Archive',
    description: 'Rain floods a dark corridor of filing cabinets, turning the archive into an impossible indoor storm.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'archive', 'rain', 'liminal'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-clockwork-tide-20260924-1045.png',
    title: 'Clockwork Tide',
    description: 'A spiral of colossal brass gears rises from dark water around a lone white shell.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'gears', 'beach', 'time'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-lantern-whale-20260924-1035.png',
    title: 'Lantern Whale',
    description: 'A whale formed from hundreds of lights floats over an empty mountain highway at dusk.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'whale', 'lanterns', 'night'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-root-server-20260924-1033.png',
    title: 'Root Server',
    description: 'A leafless tree grows from a white salt flat, its roots glowing cyan beneath the cracked surface.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'tree', 'roots', 'technology'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-inverted-lighthouse-20260924-1035.png',
    title: 'Inverted Lighthouse',
    description: 'A lighthouse hangs beneath the clouds, casting its beam downward over a dark sea.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'lighthouse', 'inverted', 'ocean'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-glass-orchard-20260924-1036.png',
    title: 'Glass Orchard',
    description: 'Alien trees with red luminous fruit stand across a volcanic plain beneath a low sun.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'orchard', 'alien', 'volcanic'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-probability-door-20260924-1036.png',
    title: 'Probability Door',
    description: 'A freestanding obsidian doorway opens a seam of warm light in an empty snowfield.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'door', 'snow', 'liminal'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-cloud-vending-20260924-1036.png',
    title: 'Cloud Vending',
    description: 'A lone vending machine glows in the desert at blue hour, its compartments holding strange light.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'vending-machine', 'desert', 'blue-hour'],
    model: 'FLUX.1 Dev Q6',
  },
  {
    src: '/gallery/bender-flux-moon-kintsugi-20260924-1037.png',
    title: 'Moon Kintsugi',
    description: 'A golden moon shines over a black sea, its reflection breaking across the surface.',
    tags: ['bender', 'mold-cli', 'flux-dev', 'moon', 'kintsugi', 'ocean'],
    model: 'FLUX.1 Dev Q6',
  },
];
