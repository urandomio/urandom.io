...
export const exhibitionSlots: ExhibitionSlot[] = [
  {
    id: "study-04", kind: "still", status: "published",
    ...
    provenance: {
      tool: "Mold", model: "flux-dev:q8", generatedAt: "2026-09-24T16:29:10Z",
      sha256: "f0819796b76aae4102b51aa95e29b7cf77c3ed019b12002f619225ba720ed732", seed: 44219071,
  ...
  {
    id: "study-05", kind: "still", status: "published",
    ...
    provenance: {
      tool: "Mold", model: "flux-dev:q8", generatedAt: "2026-09-24T16:29:50Z",
      sha256: "253c41c74b81e14539da6209b58c5aa73bfd7a27329cfa8b877f3d98ffbda62d", seed: 44219072,
  ...
  {
    id: "motion-01", kind: "motion", status: "published",
    src: "/gallery/neblina-cloud-forest-edited-motion.mp4",
    title: "Cloud Forest — Edited Motion",
    description: "An edited motion treatment of the earlier Cloud Forest still, not native AI video: a gentle cyclic zoom, slight drift and luminance pulse across the hummingbird and flowers.",
    ...
    provenance: {
      tool: "CPU edit (Pillow and FFmpeg) of Mold still", model: "flux-dev:q8 (source still; no video model)", generatedAt: "2026-09-23T20:44:18.134Z",
      sha256: "5f02e006a10f27bf5c210f6582d9f1acbfd3490a432cd8118f0d9eb8d166a641",
      prompt: "Source still: Neblina — Cloud Forest. Edited motion: 16:9 center crop, cyclic 1.8–3% zoom, slight sinusoidal drift and luminance pulse at 24 fps; no native video generation."
    }
  },
  {
    id: "motion-02", kind: "motion", status: "published",
    src: "/gallery/neblina-desert-monsoon-edited-motion.mp4",
    title: "Desert Monsoon — Edited Motion",
    description: "An edited motion treatment of the earlier Desert Monsoon still, not native AI video: a gentle cyclic zoom, slight drift and luminance pulse over the storm landscape.",
    ...
    provenance: {
      tool: "CPU edit (Pillow and FFmpeg) of Mold still", model: "flux-dev:q8 (source still; no video model)", generatedAt: "2026-09-23T20:44:55.908Z",
      sha256: "9a9aede8ab46ce397637af4745cb3684130a8d1e0e40ec9abe21c23c85192ac9",
      prompt: "Source still: Neblina — Desert Monsoon. Edited motion: 16:9 center crop, cyclic 1.8–3% zoom, slight sinusoidal drift and luminance pulse at 24 fps; no native video generation."
    }
  }
];
...
export function publishedExhibition(slots: ExhibitionSlot[]) {
  ...
  for (const slot of slots) {
    if (ids.has(slot.id)) throw new Error(`Neblina: duplicate exhibition ID ${slot.id}`);
    ids.add(slot.id);
    ...
    if (
      ...
      sources.has(src) || !title.trim() || !description.trim() || !alt.trim() ||
      !record.tool.trim() || !record.model.trim() || !record.prompt.trim() ||
